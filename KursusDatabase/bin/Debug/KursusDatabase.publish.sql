/*
Deployment script for PlaygroundEmpty
...
GO
:setvar DatabaseName "PlaygroundEmpty"
:setvar DefaultFilePrefix "PlaygroundEmpty"
...
GO
PRINT N'Creating Schema [Kursus]...';
...
GO
PRINT N'Creating Schema [KursusViews]...';


GO
CREATE SCHEMA [KursusViews]
    AUTHORIZATION [dbo];


GO
PRINT N'Creating Table [Kursus].[Planets]...';
...
CREATE TABLE [Kursus].[Planets] (
    ...
    [Mass]            DECIMAL (10, 4) NULL,
    [Diameter]        INT             NULL,
    [Gravity]         INT             NULL,
    [Density]         INT             NULL,
    [EscapeVelocity]  INT             NULL,
    [DistanceFromSun] DECIMAL (10, 4) NULL,
    [NumberOfMoons]   INT             NULL,
    [Ringsystem]      CHAR (1)        NULL,
    PRIMARY KEY CLUSTERED ([PlanetID] ASC)
);


GO
PRINT N'Creating Table [Kursus].[Child]...';
...
GO
PRINT N'Creating Table [Kursus].[Mother]...';
...
GO
PRINT N'Creating Table [Kursus].[LegalEntity]...';
...
GO
PRINT N'Creating Table [Kursus].[Account]...';
...
GO
PRINT N'Creating Table [Kursus].[RelationLegalEntityAccount]...';
...
GO
PRINT N'Creating Table [Kursus].[AccountTransaction]...';
...
GO
PRINT N'Creating Table [Kursus].[Account2]...';
...
GO
PRINT N'Creating Default Constraint unnamed constraint on [Kursus].[Planets]...';


GO
ALTER TABLE [Kursus].[Planets]
    ADD DEFAULT (NULL) FOR [EnglishName];
...
GO
ALTER TABLE [Kursus].[Planets]
    ADD DEFAULT (NULL) FOR [EscapeVelocity];
...
GO
ALTER TABLE [Kursus].[Planets]
    ADD DEFAULT (NULL) FOR [DistanceFromSun];
...
GO
ALTER TABLE [Kursus].[Planets]
    ADD DEFAULT (NULL) FOR [NumberOfMoons];
...
GO
ALTER TABLE [Kursus].[Planets]
    ADD DEFAULT (NULL) FOR [Ringsystem];


GO
PRINT N'Creating Default Constraint [Kursus].[DF_Account2_InsertTimestamp]...';


GO
ALTER TABLE [Kursus].[Account2]
    ADD CONSTRAINT [DF_Account2_InsertTimestamp] DEFAULT (getdate()) FOR [InsertTimestamp];


GO
PRINT N'Creating View [KursusViews].[Planeter]...';
